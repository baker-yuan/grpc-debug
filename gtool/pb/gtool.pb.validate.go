...
// Validate checks the field values on CallBidirectionalStreamMethodReq with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *CallBidirectionalStreamMethodReq) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CallBidirectionalStreamMethodReq with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// CallBidirectionalStreamMethodReqMultiError, or nil if none found.
func (m *CallBidirectionalStreamMethodReq) ValidateAll() error {
	return m.validate(true)
}

func (m *CallBidirectionalStreamMethodReq) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CallBidirectionalStreamMethodReqMultiError(errors)
	}

	return nil
}

// CallBidirectionalStreamMethodReqMultiError is an error wrapping multiple
// validation errors returned by
// CallBidirectionalStreamMethodReq.ValidateAll() if the designated
// constraints aren't met.
type CallBidirectionalStreamMethodReqMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CallBidirectionalStreamMethodReqMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CallBidirectionalStreamMethodReqMultiError) AllErrors() []error { return m }

// CallBidirectionalStreamMethodReqValidationError is the validation error
// returned by CallBidirectionalStreamMethodReq.Validate if the designated
// constraints aren't met.
type CallBidirectionalStreamMethodReqValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CallBidirectionalStreamMethodReqValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CallBidirectionalStreamMethodReqValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CallBidirectionalStreamMethodReqValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CallBidirectionalStreamMethodReqValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CallBidirectionalStreamMethodReqValidationError) ErrorName() string {
	return "CallBidirectionalStreamMethodReqValidationError"
}

// Error satisfies the builtin error interface
func (e CallBidirectionalStreamMethodReqValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCallBidirectionalStreamMethodReq.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CallBidirectionalStreamMethodReqValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CallBidirectionalStreamMethodReqValidationError{}
